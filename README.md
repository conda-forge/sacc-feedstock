...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sacc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8702&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sacc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sacc` can be installed with:

```
conda install sacc
```

It is possible to list all of the versions of `sacc` available on your platform with:
